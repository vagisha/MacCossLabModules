...
<% } %>
    ...
    // One upload dialog serves every tool on the page, so a file picked and then cancelled was
    // still selected when the dialog was opened again for a different tool.
