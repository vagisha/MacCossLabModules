        ...
        var form = Ext4.create('Ext.form.Panel', {
            ...
            items: [
                ...
                },
                {
                    ...
                    //afterBodyEl: '<div style="color:red;">Publication link and citation do not have to be entered if a PubMed ID is provided</div>',
                    //msgTarget : 'side'
                },
                {
                    xtype: 'component',
                ...
                },
                {
                    ...
                    hidden: <%=bean.isPublic()%>,
                    name: 'notPublished',
                    fieldLabel: "Publication Not Available",
                    checked: <%=form.isNotPublished()%>,
