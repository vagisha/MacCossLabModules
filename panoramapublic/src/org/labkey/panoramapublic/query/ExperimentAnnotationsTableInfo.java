...
public class ExperimentAnnotationsTableInfo extends FilteredTable<PanoramaPublicSchema>
{
    ...
    private ExprColumn getAuthorsColumn()
    {
        ...
        // last name. Do not use the displayname since it may not always be their full name.
    ...
    public static class ExperimentUserForeignKey extends UserIdForeignKey
    {
        ...
        private void addUser(NamedObjectList objectList, Integer userId)
        {
            ...
            else
            {
                ...
                if (group != null)
                {
                    // Direct members of the group; non-recursive
                    Set<User> grpMembers = SecurityManager.getGroupMembers(group, MemberType.ACTIVE_USERS);
