...
public class UnimodUtil
{
    ...
    */
    ...
    private static @Nullable UnimodModification getMatchIfHardCodedMod(IsotopeModification skylineMod)
    {
        ...
        {
            var modsList = unimod().getByFormula(buildIsotopeModFormula(skylineMod));
            if (modsList.size() == 1)
            {
    ...
    public static Formula buildIsotopicModFormula(char aminoAcid, boolean label2h, boolean label13c, boolean label15n, boolean label18o)
    {
        Formula formula = new Formula();
        Map<String, Integer> composition = unimod().getAminoAcidComposition(aminoAcid);
        if(composition != null)
        {
    ...
    */
    ...
    private static List<UnimodModification> getMatchesIfWildcardModification (IsotopeModification skylineMod, List<Character> aminoAcidSites)
    {
        ...
        || label13C15N.equals(skylineMod))
        {
            ...
            UnimodModifications uMods = unimod();
    ...
    public static class TestCase extends Assert
    {
        ...
        {
            var allAminoAcids = unimod().getAminoAcids();
